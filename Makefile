...
FLAGS  = -std=c++11 -g -w -O3 -I${EIGEN} -I${BOOST}/include -I/${HDF5_ROOT}/include $(VERSION_FLAGS)
DFLAGS = -std=c++11 -g -w -O3 -I${EIGEN} -I${BOOST}/include -I/${HDF5_ROOT}/include $(VERSION_FLAGS) -DComplex
...
SRC_Dice   = SHCI.cpp SHCIbasics.cpp Determinants.cpp integral.cpp input.cpp Davidson.cpp                              SHCIgetdeterminants.cpp SHCIsampledeterminants.cpp SHCIrdm.cpp SHCISortMpiUtils.cpp SHCImakeHamiltonian.cpp SHCIshm.cpp LCC.cpp symmetry.cpp OccRestrictions.cpp SHCIDataIO.cpp
SRC_ZDice2 = SHCI.cpp SHCIbasics.cpp Determinants.cpp integral.cpp input.cpp Davidson.cpp SOChelper.cpp new_anglib.cpp SHCIgetdeterminants.cpp SHCIsampledeterminants.cpp SHCIrdm.cpp SHCISortMpiUtils.cpp SHCImakeHamiltonian.cpp SHCIshm.cpp LCC.cpp symmetry.cpp OccRestrictions.cpp SHCIDataIO.cpp
...
OBJ_Dice+=    obj/SHCI.o   obj/SHCIbasics.o   obj/Determinants.o   obj/integral.o   obj/input.o   obj/Davidson.o                                        obj/SHCIgetdeterminants.o   obj/SHCIsampledeterminants.o   obj/SHCIrdm.o   obj/SHCISortMpiUtils.o   obj/SHCImakeHamiltonian.o   obj/SHCIshm.o obj/LCC.o     obj/symmetry.o  obj/OccRestrictions.o obj/SHCIDataIO.o
OBJ_ZDice2+=obj_z/SHCI.o obj_z/SHCIbasics.o obj_z/Determinants.o obj_z/integral.o obj_z/input.o obj_z/Davidson.o obj_z/SOChelper.o obj_z/new_anglib.o obj_z/SHCIgetdeterminants.o obj_z/SHCIsampledeterminants.o obj_z/SHCIrdm.o obj_z/SHCISortMpiUtils.o obj_z/SHCImakeHamiltonian.o obj_z/SHCIshm.o obj_z/LCC.o obj_z/symmetry.o  obj/OccRestrictions.o obj/SHCIDataIO.o
